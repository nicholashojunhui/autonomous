...
def talker():
	...
	#Gripper bend down (at front side)
	kinematics_pose = KinematicsPose()
	kinematics_pose.pose.position.x = 0.276
	kinematics_pose.pose.position.y = 0.000
	kinematics_pose.pose.position.z = 0.155

	kinematics_pose.pose.orientation.x = 0.000
	kinematics_pose.pose.orientation.y = 0.199
	kinematics_pose.pose.orientation.z = 0.000
	kinematics_pose.pose.orientation.w = 0.98
	...
	#Gripper bend down (at left side)
	kinematics_pose = KinematicsPose()
	kinematics_pose.pose.position.x = 0.012
	kinematics_pose.pose.position.y = 0.268
	kinematics_pose.pose.position.z = 0.167

	kinematics_pose.pose.orientation.x = -0.105
	kinematics_pose.pose.orientation.y = 0.106
	kinematics_pose.pose.orientation.z = 0.699
	kinematics_pose.pose.orientation.w = 0.699
